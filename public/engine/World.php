...
class WordBuilder {
	...
	private $worldNameFirst = ["Земля", "Страна", "Архипелаг", "Острова", "Пространство", "Пространства", "Владение", "Владения", "Королевство", "Королевства", "Остров", "Континент", "Материк"];
	private $worldNameLast = ["Могущества", "Драконов", "Отваги", "Чести", "Раскаяния", "Вольнодумства", "Ветров", "Отречения", "Порока", "Храбрости", "Мечты", "Словоблудия", "Превосходства", "Сладострастия", "Освобождения"];
